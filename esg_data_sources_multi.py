...
class MultiSourceESGFetcher:
    ...
    def fetch_esg_data(self, ticker: str, company_name: Optional[str] = None, 
        ...
        if yahoo_data:
            print(f"✅ Yahoo ESG: {company_name or ticker} → {yahoo_data.get('overall_esg_score', 0):.1f}/100")
        ...
        if finnhub_data:
            print(f"✅ Finnhub ESG: {company_name or ticker} → {finnhub_data.get('overall_esg_score', 0):.1f}/100")
        ...
        if company_name:
            ...
            if rapid_data:
                print(f"✅ RapidAPI ESG: {company_name} → {rapid_data.get('overall_esg_score', 0):.1f}/100")
        ...
        if self.fmp_key:
            ...
            if fmp_data:
                print(f"✅ FMP ESG: {company_name or ticker} → {fmp_data.get('overall_esg_score', 0):.1f}/100")
